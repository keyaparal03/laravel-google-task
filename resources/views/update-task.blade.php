        ...
        <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6">
                    ...
                    <input name="tasklistid" value="MTI5NzY2Nzc0MzE3ODczOTUxMjc6MDow" autocomplete="off">
                    <input name="taskid" value="dmtSOU1ub1hxUjhONTBpYw" autocomplete="off">
                    <input class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full" id="" name="task_name" autocomplete="off">
